...
figure
plot(s11_notfilt(:, 1), s11_notfilt(:, 4));
hold on
plot(s11_notfilt(:, 1), s11(:, 1));
title("S11 MUT (PLA) REAL");
hold off
legend('measured', 'filtered')
%xlim([2.2e10 2.75e10])

figure
plot(s11_notfilt(:, 1), s11_notfilt(:, 5));
hold on
plot(s11_notfilt(:, 1), s11(:, 2));
title("S11 MUT (PLA) IMAG");
hold off
legend('measured', 'filtered')
%xlim([2.2e10 2.75e10])

figure
plot(s11_notfilt(:, 1), s21_notfilt(:, 4));
hold on
plot(s11_notfilt(:, 1), s21(:, 1))
title("S21 MUT (PLA) REAL");
hold off
legend('measured', 'filtered')
%xlim([2.2e10 2.75e10])

figure
plot(s11_notfilt(:, 1), s21_notfilt(:, 5));
hold on
plot(s11_notfilt(:, 1), s21(:, 2));
